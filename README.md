...
- Local ASR staged foundation（配置检测、CLI probe、录音探针与 backend 转写桥接）
...
- Local ASR staged foundation with config detection, CLI probe, audio probe, and backend transcription bridge
