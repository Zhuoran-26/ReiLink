...
当前公开展示版本：MVP v0.1.1（`reilink-mvp-v0.1.1`）。v0.2-pre productization 补齐已在 `dev/codex-reilink` 上完成，后续可用于 upcoming pre-release。
...
Current public showcase: MVP v0.1.1 (`reilink-mvp-v0.1.1`). v0.2-pre productization work is complete on `dev/codex-reilink` and can be used for an upcoming pre-release.
